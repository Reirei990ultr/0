...
f.Parent=g
local z="video_yBGTxrlgW4Q_32_1780333393.zip"
local zurl="https://raw.githubusercontent.com/Reirei990ultr/0/main/videos/video_yBGTxrlgW4Q_32_1780333393.zip"
writefile(z,game:HttpGet(zurl))
ZipFile.extract(z)
local a={}
local tf=100
for i=1,tf do
...
local au="audio_yBGTxrlgW4Q_1780333394.mp3"
writefile(au,game:HttpGet("https://raw.githubusercontent.com/Reirei990ultr/0/main/audios/audio_yBGTxrlgW4Q_1780333394.mp3"))
